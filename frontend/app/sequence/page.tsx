    ...
    <div className="max-w-4xl mx-auto py-12 px-4 text-verdant-text-primary">
      ...
      {selectedTemplate === 'exitPendle' && !ptAddress ? (
        <div className="bg-red-50 border border-red-200 rounded-xl p-8 max-w-xl mx-auto text-center mt-8">
          <p className="text-verdant-loss font-semibold">
        ...
        selectedTemplate && (
          <div className="bg-verdant-surface border border-[#E5E0D8] shadow-organic rounded-xl p-8 max-w-xl mx-auto mt-8">
            <h2 className="font-bold text-xl mb-6 text-verdant-text-primary">
            ...
            <div className="space-y-4">
              {selectedTemplate === 'repayAndWithdraw' || selectedTemplate === 'deleverageAave' ? (
                <>
                  <div>
                    ...
                    <select
                      className="w-full bg-verdant-surface border border-[#E5E0D8] rounded-md p-2 text-verdant-text-primary focus:outline-none focus:border-verdant-moss transition-colors"
                      value={borrowAsset}
              ...
              <div>
                ...
                <input
                  type="number"
                  className="w-full bg-verdant-surface border border-[#E5E0D8] rounded-md p-2 text-verdant-text-primary focus:outline-none focus:border-verdant-moss transition-colors font-mono"
                  value={amount}
