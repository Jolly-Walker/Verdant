...
export function TokenIcon({ symbol, className = 'w-8 h-8' }: TokenIconProps) {
    ...
    case 'ETH':
      ...
      emblem = (
        <svg
          ...
          className="w-3.5 h-5 fill-white"
    ...
    case 'STETH':
      ...
      emblem = (
        <svg
          aria-hidden="true"
          viewBox="0 0 784 1277"
          className="w-3.5 h-5 fill-white opacity-90"
          xmlns="http://www.w3.org/2000/svg"
        >
          <polygon points="392,0 383.5,29 383.5,873.5 392,882 784,652" />
          <polygon points="392,0 0,652 392,882 392,473" />
      ...
      emblem = (
        ...
        >
          ...
          <path
            ...
            d="M12 12m-3 0a3 3 0 1 0 6 0 3 3 0 1 0 -6 0"
          />
        </svg>
      );
      break;
  ...
  return (
    <div
      className={`${className} ${gradientClass} rounded-full flex items-center justify-center shrink-0 shadow-sm border border-white/10 select-none overflow-hidden`}
    >
      {emblem}
    </div>
  );
