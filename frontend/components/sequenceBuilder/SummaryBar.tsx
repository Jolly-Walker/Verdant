...
import { canSubmit, computeTokenDelta } from '@/lib/sequenceBuilder/logic';
...
export function SummaryBar({ steps, onCancel, onExecute, isExecuting = false }: SummaryBarProps) {
